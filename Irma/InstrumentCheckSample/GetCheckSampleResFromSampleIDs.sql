...
(
	...
	Where	SampleID In ({?@SampleID}) ---(385,389,393)
)
...
declare @SampleList TABLE(NetWorkName nvarchar(50), InstrumentGroupName nvarchar(50), InstrumentName nvarchar(50),
                          SerialNumber nvarchar(50), PartNumber bigint, ProductName nvarchar(50), ProductLogicalID int,
                          Parametername nvarchar(50), PredictionModelVersion int, SampleID int, AnalysisStartUTC datetime, AnalysisDate date,
...
insert into @SampleList (NetWorkName, InstrumentGroupName, InstrumentName, SerialNumber, PartNumber, ProductName, ProductLogicalID,
                         ParameterName, PredictionModelVersion, SampleID, AnalysisStartUTC, AnalysisDate,
...
select nw.Name,
       ...
       pm.Version PredictionModelVersion,
       sp.SampleID,
       sp.AnalysisStartUTC,
       CONVERT(date, sp.AnalysisStartUTC),
       pv.DoubleResult,
       sp.EventsStatus,
...
-- This line has been removed from Report no need to do anything at this point
	'RDOutsideMD' = NULL
from @ArrowTable r1
