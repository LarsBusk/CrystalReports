...
Select		AnalysisTime
		...
		,	SampleID 
		,	v.RealSampleId
		,	ROW_NUMBER() Over (Partition By v.ProductLogicalId, v.ParameterLogicalId Order By v.RealSampleId) as RowNumber
...
Order By  v.ProductLogicalID, v.ParameterLogicalID, v.RealSampleId
